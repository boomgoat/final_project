  ...
  render() {
    ...
    return (
			...
			<div className="container">
				...
				<NavLink to='/feed' className="col-md-1 col-sm-5">
				<img className="logo" src = { logo } alt="logo"/>
				</NavLink>
							
				<input className="Search col-md-2 col-sm-2 hidden-xs" placeholder="Find Workers"/>
				<div className="mobileMenu hidden-md hidden-lg hidden-sm">
					<i className="fa fa-navicon"></i>
				</div>

				<div className="mainNav col-md-9 col-sm-5 hidden-xs">
				
					<NavLink to='/newJob' className="navL   col-md-3 hidden-sm">
						<h4>CREATE JOB</h4>
					</NavLink>
					<NavLink to='/myJobs' className="navL   col-md-3 hidden-sm">
						<h4>MY JOBS</h4>
					</NavLink>
					<NavLink to='/feed' className="navL   col-md-1 hidden-sm">
						<h4><span className="glyphicon glyphicon-home"></span></h4>
					</NavLink>
					<NavLink to='/messages' className="navL col-md-1 col-sm-2">
